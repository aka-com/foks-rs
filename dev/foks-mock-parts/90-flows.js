...
(function () {
  ...
  var TRAVEL_MAC =
    '04c1e08d5f3a94b7d21e6f0c8a3b5d7e9f1a2b3c4d5e6f708192a3b4c5d6e7f809';
  ...
  M.flow({
    ...
    steps: [
      ...
      },
      {
        ...
        page: 'fr-checked',
        set: base({ 'v.result': 'new', 'v.disclosure': 'open' }),
      ...
      {
        label: 'Get started (bail-out)',
        page: 'fr-checklist-own',
        set: base({ 'v.progress': '4' }),
  ...
  M.flow({
    ...
    steps: [
      {
        label: 'Add this as a secondary device',
        page: 'fr-who',
        set: base({}),
      ...
      },
      {
        label: 'Select a server',
        page: 'fr-address',
        set: base({ 'v.returning': 'yes', 'v.result': 'new' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'Resume acceptance refused',
        page: 'frx-existing',
        set: base({
          'v.path': 'own',
          'v.card': 'pair',
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'Later, from Settings',
        page: 'set-account',
        set: base({ 'v.sheet': 'go-profile' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'A file selected',
        page: 'all',
        set: base({
          'v.sel': 'team:household|/documents/emergency.pdf',
          'v.details': 'shown',
        }),
        note: 'A File shows its size and a download; its bytes are streamed by the local agent, never listed.',
      },
      {
        label: 'A link selected',
        page: 'store-personal',
        set: base({
          'v.sel': 'acct:personal|/latest-key',
          'v.details': 'shown',
        }),
      ...
      },
      {
        ...
        page: 'store-personal',
        set: base({
          'v.sel': 'acct:personal|/ssh/id_ed25519',
          'v.details': 'shown',
        }),
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'Refused: something is already there',
        page: 'store-personal',
        set: base({
          'v.sheet': 'exists',
          'v.dest': 'acct:personal',
          'v.epath': '/logins/github.com',
        }),
      ...
      },
      {
        label: 'Created',
        page: 'store-personal',
        set: base({ 'v.kind': 'Password', 'v.applied': 'created-password' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'Conflict: item was updated',
        page: 'store-personal',
        set: base({
          'v.sel': 'acct:personal|/logins/github.com',
          'v.details': 'shown',
      ...
      },
      {
        ...
        page: 'store-personal',
        set: base({
          'v.sel': 'acct:personal|/documents/passport-scan.pdf',
          'v.details': 'shown',
          'v.sheet': 'replace',
        }),
      ...
      },
      {
        label: 'Removed',
        page: 'store-personal',
        set: base({ 'v.details': 'shown', 'v.applied': 'removed-github' }),
  ...
  M.flow({
    ...
    steps: [
      {
        label: 'All items band',
        page: 'all',
        set: base({ acme: 'lapsed' }),
      ...
      {
        label: 'The server detail',
        page: 'srv-server',
        set: base({ acme: 'lapsed', 'v.profile': 'acme' }),
      ...
      {
        label: 'Devices stopped',
        page: 'set-devices',
        set: base({ acme: 'lapsed', 'v.account': 'acct:work' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      },
      {
        label: 'Add a group',
        page: 'eng-people',
        set: base({ 'v.sheet': 'admit', 'v.remote': 'household' }),
      ...
      },
      {
        label: 'Admitted',
        page: 'eng-people',
        set: base({ 'v.applied': 'admit:eng:household:0' }),
        note: 'A new Active federation row and a matching named-team party; there is no un-admit.',
      },
      {
        label: 'Restore the lapsed admission',
        page: 'eng-people',
        set: base({
          'v.applied': 'admit:eng:household:0,restore:eng:7c14a9f0',
        }),
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'The invite dialog',
        page: 'set-groups',
        set: base({ 'v.sheet': 'join-invite' }),
        note: 'It writes the sentence for you: your username, your server, and what they should do with it.',
      },
      {
        label: 'Whose name goes in it',
        page: 'set-groups',
        set: base({ 'v.sheet': 'join-invite', 'v.account': 'acct:personal' }),
      ...
      {
        label: 'Then add them by username',
        page: 'eng-people',
        set: base({ 'v.sheet': 'add', 'v.username': 'nils' }),
  ...
  M.flow({
    ...
    steps: [
      {
        label: 'The roster read failed',
        page: 'eng-people',
        set: base({ 'v.failure': 'roster' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'Offer from this Mac',
        page: 'set-devices',
        set: base({ 'v.sheet': 'pair-offer', 'v.seg': 'offer' }),
        note: 'The offering side: Start asks the agent for a short phrase to read out.',
      },
      {
        label: 'The phrase is on screen',
        page: 'set-devices',
        set: base({
          'v.sheet': 'pair-offer',
          'v.seg': 'offer',
      ...
      {
        label: 'Accept on this Mac',
        page: 'set-devices',
        set: base({ 'v.sheet': 'pair-accept', 'v.seg': 'accept' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      },
      {
        ...
        page: 'set-keys',
        set: base({ 'v.sheet': 'revoke', 'v.typed': '1' }),
    ...
    steps: [
      {
        label: 'Your Macs',
        page: 'set-devices',
        set: base({ 'v.account': 'acct:personal' }),
      ...
      },
      {
        ...
        page: 'set-devices',
        set: base({
          'v.account': 'acct:personal',
          'v.sheet': 'remove-device',
          'v.device': TRAVEL_MAC,
          'v.typed': '',
        }),
      ...
      },
      {
        label: 'Removed',
        page: 'set-devices',
        set: base({ 'v.account': 'acct:personal', 'v.applied': '1' }),
        note: 'The row is gone and the toast reads “Removed Travel Mac from this account”.',
      },
      {
        label: 'The current-device chip',
        page: 'set-devices',
        set: base({ 'v.account': 'acct:personal', 'v.devlist': 'keycurrent' }),
        note: 'The device you are on shows a chip instead of a button — here it is a security key, so the chip says so.',
      },
      {
        label: 'Managed under Security keys',
        page: 'set-devices',
        set: base({ 'v.account': 'acct:personal', 'v.devlist': 'plus08' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      },
      {
        ...
        page: 'srv-server',
        set: base({ 'v.profile': 'acme', 'v.status': 'rollback' }),
      ...
      },
      {
        ...
        page: 'srv-server',
        set: base({ 'v.profile': 'acme', 'v.status': 'blocked' }),
  ...
  M.flow({
    ...
    steps: [
      ...
      {
        label: 'What a managed profile changes',
        page: 'frl-local',
        set: base({ managed: 'local', 'v.result': 'ready' }),
  ...
  M.flow({
    ...
    steps: [
      {
        label: 'The stale link',
        page: 'set-unavailable',
        set: base({ 'v.account': 'acct:nope' }),
