...
For commit messages, include a short description followed by a paragraph or
bullet-point list of details. Use multiple `-m` arguments instead of embedded
`\n` escapes when committing from the command line.
