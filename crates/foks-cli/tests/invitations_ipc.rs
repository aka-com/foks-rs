...
#[test]
fn cli_and_resident_agent_publish_and_recover_original_invitation() {
    ...
    let start = credentials
        .with_checked_session(&session, |s| {
            ...
            s.create_named_team("work", "project", "project", &mut vault, &key)?;
            s.invitation_action(
                "work",
                foks_client_app::InvitationAction::Create {
