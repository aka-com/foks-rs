...
enum TeamCommand {
    ...
    /// Admits a team from another pinned profile to a local named team.
    AdmitRemote {
    ...
    RefreshRemote {
        ...
        /// every further hardware-only profile the cascade reaches.
        #[arg(long = "unlock")]
        unlocks: Vec<String>,
    },
}
    ...
    match command {
        ...
        TeamCommand::AdmitRemote {
            ...
            output(
                json,
                &report,
                "remote team admitted and reconciliation scheduled",
            )
        }
