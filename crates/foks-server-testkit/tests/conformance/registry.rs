...
const COVERAGE: &[Coverage] = &[
    Coverage {
        ...
        routes: &[
            ...
            ("TeamGuest", "lookupTeamCertByHash"),
            ("TeamMember", "grantLocalViewPermissionForTeam"),
            ("User", "grantLocalViewPermissionForUser"),
        ],
    },
    Coverage {
    ...
    Coverage {
        ...
        routes: &[
            ...
            ("RealTime", "rtGetInboxVersion"),
            ("RealTime", "rtGetChangedThreads"),
            ("RealTime", "rtReadThrough"),
            ("RealTime", "rtPollInbox"),
