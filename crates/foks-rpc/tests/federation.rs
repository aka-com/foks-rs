...
fn federation_requests_match_the_go_v019_oracle() {
    ...
    assert_eq!(
        ...
        .unwrap(),
        hex("")
    );

    let team = entity(ENTITY_NAMED_TEAM, 0x66);
    assert_eq!(
        encode_load_remote_team_chain_request(&team, &remote_host, &token, 1, None).unwrap(),
        hex("6e950500cef9128579039792c421036666666666666666666666666666666666666666666666666666666666666666c421022222222222222222222222222222222222222222222222222222222222222222920281a131c411505152535455565758595a5b5c5d5e5f6001c0c0c2c2")
    );
    ...
    assert_eq!(
        ...
        .unwrap(),
        hex("")
    );
}
